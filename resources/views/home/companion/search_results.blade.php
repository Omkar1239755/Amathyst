        ...
        <div class="row g-4">
            @foreach($companions as $companion)
             <div class="col-12 col-sm-6 col-md-9 col-lg-3">
                <div class="card profile-cardindex h-60">
                    @if ($companion->profile_picture)
                      <img src="{{asset('uploads/profilecompanion/'.$companion->profile_picture)}}" class="card-img-top" width=100 height=100 alt="..." />
                      @else
                  ...
                  <div class="card-body prrofile-boddy">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <h5 class="card-title mb-0 title-profile">{{$companion->name}}</h5>
                      <span class="rating-index d-flex align-items-center">
                        <img src="{{asset('assests/images/ratingimg.svg')}}" alt="rating" width="15px" class="me-1">
                        4.5
                      </span>
                    </div>
                     @php
                    ...
                    <p class="card-text txt-profile"><img src="{{asset('assests/images/gemsimg.svg')}}" alt="gems" width="15px"> Start from <span>  {{ $gem?$gem:0}} Gems</span>
                    </p>
